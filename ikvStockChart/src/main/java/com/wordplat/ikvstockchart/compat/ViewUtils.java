...
public class ViewUtils {
    ...
    public static SizeColor getSizeColor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            //高亮类型
            int integer = a.getInteger(R.styleable.InteractiveKLineView_highlightStyle, HightLightStyle.OUT.ordinal());
            sizeColor.setHightLightStyle(HightLightStyle.values()[integer]);
