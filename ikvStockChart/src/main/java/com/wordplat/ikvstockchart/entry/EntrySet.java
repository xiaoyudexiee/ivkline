...
public class EntrySet {
    ...
    private void computeMA() {
        ...
        for (int i = 0; i < entries.size(); i++) {
            ...
            if (i >= 10) {
                ...
                entry.setVolumeMa10(volumeMa10 / 10f);
            } else {
            ...
            if (i >= 30) {
                ma20 -= entries.get(i - 30).getClose();
                entry.setMa20(ma20 / 30f);

                volumeMa20 -= entries.get(i - 30).getVolume();
                entry.setVolumeMa20(volumeMa20 / 30f);

            } else {
                entry.setMa20(ma20 / (i + 1f));

                entry.setVolumeMa20(volumeMa20 / (i + 1f));
            }
        }
    }
    ...
    private void computeKDJ() {
        ...
        for (int i = 0; i < entries.size(); i++) {
            ...
            entry.setD(d);
            entry.setJ(3f * k - 2 * d);
            Log.d("kdj","k:"+k+"  d:"+d+"  j:"+(3f * k - 2 * d)+"   max9 - min9:"+(max9 - min9)+"   rsv:"+rsv);
        }
    }
}
