...
public class SizeColor {
    ...
    private HightLightStyle hightLightStyle = HightLightStyle.IN;


    public HightLightStyle getHightLightStyle() {
        return hightLightStyle;
    }

    public void setHightLightStyle(HightLightStyle hightLightStyle) {
