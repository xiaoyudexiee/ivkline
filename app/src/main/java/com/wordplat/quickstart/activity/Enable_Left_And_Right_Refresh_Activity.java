...
public class Enable_Left_And_Right_Refresh_Activity extends BaseActivity {
    ...
    @ViewInject(R.id.tv_line) private TextView tvLine;
    @ViewInject(R.id.tv_candle) private TextView tvCandle ;
    ...
    private void initListener() {
        tvLine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                kLineLayout.showFenShi();
            }
        });

        tvCandle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                kLineLayout.showCandle(1);
            }
        });
    }
